...
float getTemp(int port)
{
    float temp = 0;             // Beispieldaten. Muss =0 wenn Raspberry aktiv
...
float getLuftfeuchtigkeit(int port)
{
    float humidity = 0;             // Beispieldaten. Muss =0 wenn Raspberry aktiv
...
int getLicht(int port)
{
    int value=0;                                    // Beispieldaten. Muss =0 wenn Raspberry aktiv
...
int getSound(int port)
{
    int sound = 0;          // Beispieldaten. Muss =0 wenn Raspberry aktiv
    pinMode(port, INPUT);   //Muss für Raspberry-Funktionen aktiv sein
    pi_sleep(1000);         //Muss für Raspberry-Funktionen aktiv sein
